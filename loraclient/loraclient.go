// Copyright 2016 The go-lora Authors
// This file is part of the go-lora library.
//
// The go-lora library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The go-lora library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the go-lora library. If not, see <http://www.gnu.org/licenses/>.

// Package ethclient provides a client for the Lora RPC API.
package ethclient
...
import (
	...
	"github.com/lora/go-lora"
	"github.com/lora/go-lora/common"
	"github.com/lora/go-lora/common/hexutil"
	"github.com/lora/go-lora/core/types"
	"github.com/lora/go-lora/rpc"
)

// Client defines typed wrappers for the Lora RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, lora.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*lora.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (lora.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q lora.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q lora.FilterQuery, ch chan<- types.Log) (lora.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q lora.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg lora.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg lora.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg lora.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*lora.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg lora.CallMsg) (uint64, error) {
...
func toCallArg(msg lora.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *lora.SyncProgress {
	if p == nil {
		return nil
	}
	return &lora.SyncProgress{
